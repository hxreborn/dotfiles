...
# Preserve fzf-tab completion after resetting keymaps
if typeset -f fzf-tab-complete >/dev/null; then
...
# ── alt+arrows (xterm CSI 1;3X) ──────────────────────────────────────────────
bind_emacs '^[[1;3C' forward-word         # Alt+Right
bind_emacs '^[[1;3D' backward-word        # Alt+Left
